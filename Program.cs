// Инициализируем и вводим массив через запятую
...
// Также, если пользователь случайно введет две запятые подряд, получим пустые элементы. Используем условие word != string.Empty
foreach (string word in words)
{
    if (word.Length < 4 && word != string.Empty) countNewElements++;
}
if (countNewElements == 0) {Console.WriteLine(); return;}// Если не введено элементов удовлетворяющих условию задачи
